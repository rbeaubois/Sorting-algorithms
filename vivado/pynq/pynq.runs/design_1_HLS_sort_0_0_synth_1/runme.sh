...
HD_PWD='/home/rbeaubois/Documents/ENSEIRB/Sorting-algorithms/vivado/pynq/pynq.runs/design_1_HLS_sort_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HLS_sort_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HLS_sort_0_0.tcl

...
plot "insertion_results.csv" using 1:4 title 'insertion min duration' with line
set title "PYNQ CPU Benchmark results"
plot "insertion_results_pynq.csv" using 1:4 title 'insertion min duration' with line
unset multiplot

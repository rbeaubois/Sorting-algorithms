...
(* CORE_GENERATION_INFO="HLS_sort,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.674000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=264,HLS_SYN_DSP=0,HLS_SYN_FF=1497,HLS_SYN_LUT=3388,HLS_VERSION=2018_2}" *)
...
wire   [16:0] i_2_fu_410_p2;
reg   [16:0] i_2_reg_629;
...
wire   [16:0] i_3_fu_545_p2;
reg   [16:0] i_3_reg_669;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state20)) begin
        tab_address0 = tmp_3_fu_551_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
        tab_address0 = tmp_2_fu_441_p1;
...
assign i_2_fu_410_p2 = (i_reg_288 + 17'd1);

assign i_3_fu_545_p2 = (i_1_reg_355 + 17'd1);
...
assign tmp_2_fu_441_p1 = i_reg_288;

assign tmp_2_i_fu_499_p2 = ((invdar2_i_reg_311 == 8'd255) ? 1'b1 : 1'b0);

assign tmp_3_fu_551_p1 = i_1_reg_355;

assign tmp_3_i_fu_511_p1 = invdar5_i_reg_322;

assign tmp_4_fu_556_p2 = ((i_1_reg_355 == 17'd65535) ? 1'b1 : 1'b0);
...
assign tmp_last_V_fu_562_p2 = (val_4_reg_344 | tmp_4_fu_556_p2);

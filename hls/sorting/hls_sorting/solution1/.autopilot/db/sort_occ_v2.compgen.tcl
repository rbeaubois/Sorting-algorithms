...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename array_dst \
    op interface \
    ports { array_dst_address0 { O 16 vector } array_dst_ce0 { O 1 bit } array_dst_we0 { O 1 bit } array_dst_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'array_dst'"
}
}

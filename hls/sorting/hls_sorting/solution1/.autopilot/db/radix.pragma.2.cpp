# 1 "/home/rbeaubois/Documents/ENSEIRB/Sorting-algorithms/hls/sorting/hls_sorting/solution1/.autopilot/db/radix.pragma.1.cpp"
# 1 "/home/rbeaubois/Documents/ENSEIRB/Sorting-algorithms/hls/sorting/hls_sorting/solution1/.autopilot/db/radix.pragma.1.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 1 "/home/Xilinx/Vivado/2018.2/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 157 "/home/Xilinx/Vivado/2018.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
extern "C" {
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/rbeaubois/Documents/ENSEIRB/Sorting-algorithms/hls/sorting/hls_sorting/solution1/.autopilot/db/radix.pragma.1.cpp" 2
# 1 "hls_src/radix/radix.cpp"
# 1 "hls_src/radix/radix.cpp" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 155 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "hls_src/radix/radix.cpp" 2
# 1 "hls_src/radix/radix.h" 1
...
# 1 "/home/Xilinx/Vivado/2018.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 1 3 4
# 31 "/home/Xilinx/Vivado/2018.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stddef.h" 3 4
...
# 1 "/home/Xilinx/Vivado/2018.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 1 3 4
# 30 "/home/Xilinx/Vivado/2018.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/home/Xilinx/Vivado/2018.2/lnx64/tools/clang/bin/../lib/clang/3.1/include/stdarg.h" 3 4
...
# 6 "hls_src/radix/radix.h" 2
# 28 "hls_src/radix/radix.h"
...
# 2 "hls_src/radix/radix.cpp" 2



void radix_sort(unsigned int *array1, int n){
    unsigned int shift = 0;
    unsigned int array2[65536];
...
void count_sort(unsigned int *array_src, unsigned int *array_dst, int n, unsigned int shift){
    ...
    for (i = 0; i < n; i++){
        count[(array_src[i]>>shift)&0x000000FF]++;
    }
    ...
    for (i = n - 1; i >= 0; i--)
    {
        array_dst[count[(array_src[i]>>shift)&0x000000FF] - 1] = array_src[i];
        count[(array_src[i]>>shift)&0x000000FF]--;
    }
}
...
_ssdm_Unroll(1, 0, 4, "");
 tmp = array_src[i];
        c1[tmp&0x000000FF]++;
        c2[(tmp>>8)&0x000000FF]++;
        c3[(tmp>>(2*8))&0x000000FF]++;
        c4[(tmp>>(3*8))&0x000000FF]++;
    }

...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("M_AXIS_TDATA", 32, hls_out, 7, "axis", "out_data", 1),
	Port_Property("M_AXIS_TVALID", 1, hls_out, 13, "axis", "out_vld", 1),
	Port_Property("M_AXIS_TREADY", 1, hls_in, 13, "axis", "out_acc", 1),
	Port_Property("M_AXIS_TKEEP", 4, hls_out, 8, "axis", "out_data", 1),
	Port_Property("M_AXIS_TSTRB", 4, hls_out, 9, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "HLS_sort";

...
proc create_root_design { parentCell } {
  ...
  set HLS_accel_0 [ create_bd_cell -type ip -vlnv mateck:eirbsort:HLS_accel:0.1 HLS_accel_0 ]
  ...
  connect_bd_intf_net -intf_net HLS_accel_0_M_AXIS [get_bd_intf_pins HLS_accel_0/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins HLS_accel_0/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
